                    ...
                    <br>
                        <div class="col-lg-7">
                            <div class="p-8" >
                                            ...
                                            <form action="/admin/ajout_actualite" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-control-user" id="contenue" name="contenue" rows="3" required></textarea>
                                                </div>

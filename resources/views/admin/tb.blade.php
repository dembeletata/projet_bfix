            ...
            <div class="col-2 shadow-lg align-items-center" style="height: 100vh; background-color: rgba(0, 0, 0, 0.95)" >
              ...
              <nav id="navbar-example3" class="align-items-center flex-column align-items-stretch pe-4 " style="padding-left: 20px; margin-top:20px">
                ...
                <div class=" fixed-top shadow-lg  align-items-center">
                    <p class="" style="padding: 5px; font-size: 25px; margin-left:250px; margin-top:5px; color:rgb(123, 123, 123)">Tableau de bord</p>
                </div>
                ...
                <div id="d" class="col-10" style="background-color: rgb(234, 234, 234)" >
                    ...
                    <div class="d-inline-flex gap-1  d-flex justify-content-around">
                        ...
                        <div  class="shadow-lg align-items-center" style="border-radius: 10px; padding:40px; background-color: white; color: rgb(0, 128, 255); font-size:20px; border-left: 5px solid rgb(0, 128, 255); margin-left: 25px">
                        ...
                        Nombre Demandes <br> <p style="font-size: 100px; text-align: center">{{$nmbDemande}}</p>
                        </div>
                        <div  class="shadow-lg align-items-center" style="border-radius: 10px; padding:40px; background-color: white; color: rgb(0, 178, 42); font-size:20px; border-left: 5px solid rgb(0, 178, 42); margin-left: 90px">
                            ...
                            Demandes Acceptées <br> <p style="font-size: 100px; text-align: center">{{$nmbDemandeA}}</p>
                        </div>
                        <div  class="shadow-lg align-items-center" style="border-radius: 10px; padding:40px; background-color: white; color: rgb(255, 0, 0); font-size:20px; border-left: 5px solid rgb(255, 0, 0); margin-left: 90px">
                            ...
                            Demandes Refusées <br> <p style="font-size: 100px; text-align: center">{{$nmbDemandeR}}</p>
                        </div>
                    </div>
                    <br>
                    <br>
                    ...
                    <div class="d-inline-flex gap-1  d-flex justify-content-around">
                        ...
                        <div  class="shadow-lg align-items-center" style="border-radius: 10px; padding:40px; background-color: white; color: rgb(255, 140, 0); font-size:20px; border-left: 5px solid rgb(255, 140, 0); margin-left: 25px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16">
                                <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.5a1 1 0 0 0-.8.4l-1.9 2.533a1 1 0 0 1-1.6 0L5.3 12.4a1 1 0 0 0-.8-.4H2a2 2 0 0 1-2-2zm3.5 1a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1zm0 2.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1zm0 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1z"/>
                            </svg>
                            Nombre de Message <br> <p style="font-size: 100px; text-align: center">{{$nmbContact}}</p>
                        </div>
                        <div  class="shadow-lg align-items-center" style="border-radius: 10px; padding:40px; background-color: white; color: rgb(255, 140, 0); font-size:20px; border-left: 5px solid rgb(255, 140, 0); margin-left: 90px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                                <path d="M2.5 3.5a.5.5 0 0 1 0-1h11a.5.5 0 0 1 0 1zm2-2a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1zM0 13a1.5 1.5 0 0 0 1.5 1.5h13A1.5 1.5 0 0 0 16 13V6a1.5 1.5 0 0 0-1.5-1.5h-13A1.5 1.5 0 0 0 0 6zm6.258-6.437a.5.5 0 0 1 .507.013l4 2.5a.5.5 0 0 1 0 .848l-4 2.5A.5.5 0 0 1 6 12V7a.5.5 0 0 1 .258-.437"/>
                            </svg>
                            Nombre d'Actualité <br> <p style="font-size: 100px; text-align: center">{{$nmbActualite}}</p>
                        </div>
                    </div>
                </div>

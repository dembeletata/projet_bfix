...
<html lang="fr">
    <head>
        ...
        <title>Procéduree d'adhesion</title>
    ...
    <body >
        ...
        <div class="container" style="padding: 5%">
            <h1 style="color: rgb(0, 178, 42);"><strong>Cette page en construction. Les administrateurs sont à pied d'oeuvre pour le contenu de la page.</strong></h1>
        </div>
